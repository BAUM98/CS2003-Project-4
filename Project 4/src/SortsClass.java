...
public class SortsClass {
	...
	public static void insertionSort(Comparable[] theArray, int n, int first, int last) {
		// ---------------------------------------------------
		// Sorts the items in an array into ascending order.
		// Precondition: theArray is an array of n items.
		// Postcondition: theArray is sorted into ascending
		...
		for (int unsorted = first + 1; unsorted < last + 1; ++unsorted) {
			...
			int loc = unsorted;
			while ((loc > first) && (theArray[loc - 1].compareTo(nextItem) > 0)) {
	...
	public static void merge(Comparable[] theArray, int first, int mid, int last) {
		// ---------------------------------------------------------
	...
	private static void choosePivot(Comparable[] theArray, int first, int last, boolean b) {
		// ---------------------------------------------------------
		...
		// ---------------------------------------------------------
		if (b) {
			int rand = (int) ((last - first) * Math.random()) + first;
			Comparable a = theArray[first];
			theArray[first] = theArray[rand];
			theArray[rand] = a;
		}
	} // end choosePivot

	private static int partition(Comparable[] theArray, int first, int last, boolean a) {
		// ---------------------------------------------------------
		...
		choosePivot(theArray, first, last, a);
	...
	public static void quickSort(Comparable[] theArray, int first, int last, boolean a) {
		// ---------------------------------------------------------
		// Sorts the items in an array into ascending order.
		// Precondition: theArray[first..last] is an array.
		// Postcondition: theArray[first..last] is sorted.
		...
		if (first < last) {
			...
			pivotIndex = partition(theArray, first, last, a);
			// sort regions S1 and S2
			quickSort(theArray, first, pivotIndex - 1, a);
			quickSort(theArray, pivotIndex + 1, last, a);
		} // end if
	} // end quickSort
